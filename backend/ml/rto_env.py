...
class CompressorEnv(gym.Env):
    ...
    def step(self, action: np.ndarray):
        ...
        norm_efficiency = self._normalize(efficiency, self.norm_ranges['efficiency_min'], self.norm_ranges['efficiency_max'])
        norm_power = 1 - self._normalize(power, self.norm_ranges['power_min'], self.norm_ranges['power_max'])
        norm_vibration = 1 - self._normalize(vibration, self.norm_ranges['vibration_min'], self.norm_ranges['vibration_max'])
