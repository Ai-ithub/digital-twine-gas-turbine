...
def main():
    ...
    if not consumer:
        logging.error("Could not establish a connection to Kafka after multiple retries. Exiting.")
        return
    ...
    try:
        ...
        logging.info(f"Successfully connected to InfluxDB bucket: {INFLUXDB_BUCKET_VALIDATED}")
    except Exception as e:
    ...
    for message in consumer:
        ...
        try:
            ...
            logging.info(f"Data point successfully written to InfluxDB.")
