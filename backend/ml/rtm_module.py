...
class AnomalyDetector:
    ...
    def load_model(self):
        ...
        try:
            ...
            print(
                f"✅ Anomaly detection model loaded successfully from {self.model_path}"
            )
    ...
    def predict(self, data_row: dict):
        ...
        try:
            ...
            print(
                "❌ Error during prediction: One or more required features are missing from the input data."
            )
            return None
        except Exception as e:
...
if __name__ == "__main__":
    ...
    if detector.session:
        ...
        sample_data = {
            ...
            "Flow_Rate": 12.0,
            "Pressure_Out": 18.0,
            "Temperature_Out": 200.0,
            "Efficiency": 0.82,
            "Power_Consumption": 5800,
            "Vibration": 1.5,
        ...
        if prediction is not None:
            ...
            print(
                f"Output: {prediction} ({'Anomaly' if prediction == -1 else 'Normal'})"
            )
