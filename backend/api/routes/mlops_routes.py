...
def get_models_status():
    ...
    try:
        ...
        rul_model_status = {"model_loaded": True, "scaler_loaded": True} # Assuming pdm-batch-runner handles it
        rto_model_status = {"model_loaded": True, "scaler_loaded": True} # Assuming rto-consumer handles it
        ...
        all_ok = all(s['model_loaded'] and s['scaler_loaded'] for s in final_status.values())
